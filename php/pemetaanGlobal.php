      ...
      <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
          ...
          <li class="text-center">
            ...
            <li>
              <a class="active-menu"  href="pemetaanGlobal.php"><i class="bi bi-geo-alt-fill"></i> Pemetaan Global</a>
            </li>
            <li>
                  ...
                  L.control.layers(baseMaps).addTo(mymap);
                    ...
                    var markers = L.markerClusterGroup();
                      <?php  foreach($global_lokasi as $key) :?>
                          var lokasi =L.marker([<?= $key["attributes"]["Lat"];?>,<?= $key["attributes"]["Long_"];?>]).bindPopup("Negara: <?= $key["attributes"]["Country_Region"];?><br>"+
